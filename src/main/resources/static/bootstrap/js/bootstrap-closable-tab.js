var closableTab = {
	...
	addTab:function(tabItem){ //tabItem = {id,name,url,closable}
		...
		if(!$('#'+id)[0]){
			var li_tab = '<li role="presentation" class="" id="'+id+'"><a href="#'+container+'"  role="tab" data-toggle="tab" style="position: relative;padding:10px 20px 2px 15px">'+tabItem.name;
			if(tabItem.closable){
		 	...
		 	var tabpanel = '<div role="tabpanel" class="tab-pane" id="'+container+'" style="width: 100%;height: 100%;">'+
	    					  '<iframe src="'+tabItem.url+'" id="tab_frame_2" frameborder="0" style="width:100%;height: 100%" scrolling="no"  onload="closableTab.frameLoad(this)"></iframe>'+
	    				   '</div>';
